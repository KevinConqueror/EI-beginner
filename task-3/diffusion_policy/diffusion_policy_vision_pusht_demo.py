...
Original file is located at
    https://colab.research.google.com/drive/18S8Niy_MZfYL8wPeqbPo9oVAom3cs_EY
"""
...
# # 创建 Python 3.10 环境
# /usr/local/miniconda/bin/conda init
# /usr/local/miniconda/bin/conda create -y -n py310 python=3.10
# /usr/local/miniconda/bin/conda activate py310
# pip install torch==1.13.1 torchvision==0.14.1 diffusers==0.18.2 scikit-image==0.19.3 scikit-video==1.1.11 zarr==2.13.0 numcodecs==0.10.2 pygame==2.1.2 pymunk==6.2.1 gym==0.26.2 shapely==1.8.4 opencv-python==4.5.4.60 numpy==1.23.5 huggingface_hub==0.16.4 opencv-python gdown
